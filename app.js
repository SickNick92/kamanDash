...
app.use(express.static(path.join(__dirname ,'node_modules/bootswatch/dist/darkly' )));
app.use(express.static(path.join(__dirname ,'node_modules/rickshaw' )));
...
app.use(express.static(path.join(__dirname ,'node_modules/angular-chart.js/dist' )));
